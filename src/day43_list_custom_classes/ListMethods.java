...
public class ListMethods {
    ...
    public static List<String> getDays() {
       // List<String>day =new ArrayList<>(Arrays.asList("Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"));
...
//                nums.add(n);
//            }
            nums.add(random.nextInt(101));//generat random number and add to list
        }
        return nums;
    }
